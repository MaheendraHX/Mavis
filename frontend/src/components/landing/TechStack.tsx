...
export function TechStack() {
  return (
    <section id="tech" className="border-b border-line bg-cream py-20 sm:py-24">
        ...
        <div className="flex flex-col gap-8 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Reveal delay={0.08} className="sm:max-w-lg">
            <ul className="flex flex-wrap gap-2">
              ...
              <li
                key={tech}
                className="rounded-full border border-line bg-white px-4 py-2 font-mono text-[11px] uppercase tracking-[0.14em] text-muted transition-colors hover:border-tan hover:text-ink">
