  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        borderRadius: '50%',
        background: `
          radial-gradient(circle at 40% 35%, rgba(210,222,160,0.25), transparent 40%),
          radial-gradient(circle at 55% 50%, rgba(35,96,136,0.35), transparent 45%),
      ...
      <h1 style={{
        ...
        {text}
        <span style={{ animation: 'blink 0.8s step-end infinite', color: palette.olive }}>|</span>
      </h1>
      ...
      <div style={{
        width: 200,
        height: 2,
        background: 'rgba(210,222,160,0.08)',
        borderRadius: 1,
        overflow: 'hidden',
      }}>
        <div style={{
          height: '100%',
          width: `${progress}%`,
          background: `linear-gradient(90deg, ${palette.steel}, ${palette.olive})`,
          borderRadius: 1,
