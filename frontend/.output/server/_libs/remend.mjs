var cn = Object.defineProperty, un = Object.defineProperties;
var fn = Object.getOwnPropertyDescriptors;
var $ = Object.getOwnPropertySymbols;
var dn = Object.prototype.hasOwnProperty, gn = Object.prototype.propertyIsEnumerable;
var O = (n, r, e) => r in n ? cn(n, r, { enumerable: true, configurable: true, writable: true, value: e }) : n[r] = e, I = (n, r) => {
...
var mn = /^(\s*(?:[-*+]|\d+[.)]) +)>(=?\s*[$]?\d)/gm, E = (n) => !n || typeof n != "string" || !n.includes(">") ? n : n.replace(mn, (r, e, i, s) => c(n, s) ? r : `${e}\\>${i}`);
var M = /(\*\*)([^*]*\*?)$/, N = /(__)([^_]*?)$/, y = /(\*\*\*)([^*]*?)$/, R = /(\*)([^*]*?)$/, U = /(_)([^_]*?)$/, W = /(`)([^`]*?)$/, K = /(~~)([^~]*?)$/, d = /^[\s_~*`]*$/, b = /^[\s]*[-*+][\s]+$/, H = /[\p{L}\p{N}_]/u, D = /^```[^`\n]*```?$/, w = /^\*{4,}$/;
var G = /(__)([^_]+)_$/, F = /(~~)([^~]+)~$/;
var T = /~~/g;
var g = (n) => {
  if (!n) return false;
...
`)), Y = (n) => {
  ...
  return r;
}, bn = (n, r, e, i) => !!(e === "\\" || n.includes("$") && h(n, r) || m(n, r) || z(n, r) || e === "_" || i === "_" || e && i && g(e) && g(i)), Tn = (n) => {
  let r = 0, e = false, i = n.length;
  for (let s = 0; s < i; s += 1) {
    if (n[s] === "`" && s + 2 < i && n[s + 1] === "`" && n[s + 2] === "`") {
      e = !e, s += 2;
...
`; ) r -= 1;
  ...
  let r = A(n), e = Y(n);
  return r % 2 === 0 && e % 2 === 0;
}, On = (n, r, e) => !r || d.test(r) || c(n, e) || f(n, e) ? true : p(n, e, "*"), V = (n) => {
...
`) ? null : n.endsWith("``") && !n.endsWith("```") ? `${n}\`` : n, Mn = (n) => (n.match(/```/g) || []).length % 2 === 1, nn = (n) => {
  let r = En(n);
  if (r !== null) return r;
  let e = n.match(W);
  if (e && !Mn(n)) {
...
var en = (n, r) => r >= 2 && n.substring(r - 2, r + 1) === "```" || r >= 1 && n.substring(r - 1, r + 2) === "```" || r <= n.length - 3 && n.substring(r, r + 3) === "```", Nn = (n) => {
  let r = 0, e = false;
...
`) ? `${n}
$$` : `${n}$$`;
}, rn = (n) => Nn(n) % 2 === 0 ? n : Rn(n), sn = (n) => yn(n) % 2 === 1 ? `${n}$` : n;
var Un = (n, r, e) => {
...
var Kn = /^-{1,2}$/, Hn = /^[\s]*-{1,2}[\s]+$/, Dn = /^={1,2}$/, wn = /^[\s]*={1,2}[\s]+$/, ln = (n) => {
...
var Gn = new RegExp("(?<=[\\p{L}\\p{N}_])~(?!~)(?=[\\p{L}\\p{N}_])", "gu"), tn = (n) => !n || typeof n != "string" || !n.includes("~") ? n : n.replace(Gn, (r, e) => c(n, e) ? r : "\\~");
var an = (n) => {
  var e, i;
  let r = n.match(K);
  if (r) {
